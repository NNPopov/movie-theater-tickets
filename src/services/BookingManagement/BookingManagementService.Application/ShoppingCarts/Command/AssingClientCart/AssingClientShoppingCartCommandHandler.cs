...
public class AssignClientCartCommandHandler(
        ...
        IRequestHandler<AssignClientCartCommand, Result>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var existingShoppingCartId =
            await activeShoppingCartRepository.GetActiveShoppingCartByClientIdAsync(request.ClientId);
        ...
        if (existingShoppingCartId != Guid.Empty)
        {
            ...
            {
                return DomainErrors<AssignClientCartCommandHandler>.ConflictException(
                    "Active Shopping cart already exists");
            }
        }
